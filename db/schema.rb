...
ActiveRecord::Schema[8.1].define(version: 2026_08_29_094411) do
  ...
  create_table "families", force: :cascade do |t|
    ...
    t.date "last_energy_updated_on"
    t.string "name"
    t.integer "role_bonus"
    t.datetime "updated_at", null: false
  end
  ...
  create_table "reward_requests", force: :cascade do |t|
    ...
    t.index ["user_reward_card_id"], name: "index_reward_requests_on_user_reward_card_id"
  end
  ...
  add_foreign_key "reward_requests", "user_reward_cards"
